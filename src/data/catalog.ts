...
export const catalog: CatalogSection[] = [
  ...
  },
  {
    ...
    products: [
      ...
      {
        code: "SBR-CL-FLR",
        name: "فريدا فلور مطهر ومنظف — ليمون",
        size: "4 لتر",
        unit: "كرتونة — 4 عبوات",
        price: 480,
        inStock: true,
        availability: "متوفر",
        image: "/assets/cleaning-floor-frida-lemon-4l.jpg",
        imageAlt: "عبوة فريدا فلور مطهر ومنظف برائحة الليمون 4 لتر",
      },
      {
        code: "SBR-CL-AIR",
        ...
        inStock: true,
        availability: "متوفر",
        image: "/assets/cleaning-air-freshener-frida-treasure.jpg",
        imageAlt: "بخاخ معطر جو فريدا أكوا سنسيشنز كنزي",
      },
    ],
  },
  {
